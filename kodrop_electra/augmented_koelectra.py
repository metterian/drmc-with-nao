...
class NumericallyAugmentedBERT(Model):
    ...
    def __init__(self,
        ...
        model_electra = ElectraModel.from_pretrained("monologg/koelectra-base-v2-discriminator")

        #self.BERT = BertModel.from_pretrained(bert_pretrained_model)
        self.BERT = model_electra
    ...
    def forward(self,  # type: ignore
        ...
        # print('cls_sep_mask', cls_sep_mask.shape)
        # Shape: (batch_size, seqlen)
        ...
        bert_out = self.BERT(input_ids = question_passage_tokens, token_type_ids = seqlen_ids, attention_mask = pad_mask)
        # Shape: (batch_size, qlen, bert_dim)
        #bert_out = torch.tensor(bert_out)
        bert_out = bert_out[0]
