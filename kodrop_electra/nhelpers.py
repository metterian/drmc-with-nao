...
def get_number_from_word(word):
    ...
    #print(word)
    #num_dict = {"first":1, "second":2, "third":3, "fourth":4, "fifth": 5}
...
def beam_search(K, log_probs, number_mask, op_mask, END, NUM_OPS):
    ...
    with torch.no_grad():
        ...
        mask_templates[number_mask.unsqueeze(1).expand_as(mask_templates).bool()] = 1
        # mask_templates[:,0,:][op_mask.byte()] = 0
        mask_templates[:,0,:][op_mask.bool()] = 0
