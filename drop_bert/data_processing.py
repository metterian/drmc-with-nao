...
class BertDropTokenIndexer(WordpieceIndexer):
    def __init__(self,
        ...
        #bert_tokenizer = KoBertTokenizer.from_pretrained('monologg/kobert', do_lower_case = True)
...
class BertDropReader(DatasetReader):
    ...
    def _read(self, file_path: str):
        ...
        num_dict = {"first": 1, "second": 2, "third": 3, "fourth": 4, "fifth": 5, "1970s": 1970, "1950s":1950,
        ...
        for passage_id, passage_info in tqdm(dataset.items()):
            ...
            for token in word_tokens:
                #print(token)
                #if str(token) in ["first", "second", "third", "fourth", "fifth", "1970s", "1950s", "1960s", "1980s", "1990s", "2010s", "2000s", "1940s", "1930s", "1920s"]:
